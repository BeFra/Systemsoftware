...
Currently available applets include:
	...
	ash, bash, cat, chmod, chown, dmesg, echo, egrep, fgrep, free,
	fstrim, grep, halt, httpd, ifconfig, init, kill, killall, killall5,
	loadkmap, ls, mdev, mount, mv, ping, poweroff, ps, reboot, rm,
	route, sh, telnetd, top, touch, tty, udhcpc, umount, uname, uptime,
	vi
